      ...
      {!social ? null : (
        <div className="c-hero__social cell medium-6 large-8 grid-x align-center-middle">
          {(!social.facebook) ? null : (
            <a href={social.facebook} className="cell medium-1 small-2 large-1" target="_blank" rel="noopener noreferrer">
          ...
          {(!social.twitter) ? null : (
            <a href={social.twitter} className="cell medium-1 small-2 large-1" target="_blank" rel="noopener noreferrer">
          ...
          {(!social.github) ? null : (
            <a href={social.github} className="cell medium-1 small-2 large-1" target="_blank" rel="noopener noreferrer">
          ...
          {(!social.linkedin) ? null : (
            <a href={social.linkedin} className="cell medium-1 small-2 large-1" target="_blank" rel="noopener noreferrer">
